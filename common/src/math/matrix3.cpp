                              ...
                              Matrix3& kR)
{
    ...
    float fZ = kA[0][1];
    float fInvLength = 1.f / sqrtf(fY*fY+fZ*fZ);
    ...
    fY = kA[0][0];
    fZ = kA[1][0];
    fInvLength = 1.f / sqrtf(fY*fY+fZ*fZ);
    fSin = fZ*fInvLength;
    fCos = -fY*fInvLength;
    ...
    for (unsigned int i = 0; i < msSvdMaxIterations; i++)
    {
        ...
        if ( bTest1 )
        {
            ...
            else
            {
                ...
                fCos0 = 1.f / sqrtf(1.0f+fTan0*fTan0);
                fSin0 = fTan0*fCos0;
                ...
                fCos1 = 1.f / sqrtf(1.0f+fTan1*fTan1);
                fSin1 = -fTan1*fCos1;
...
void Matrix3::Orthonormalize ()
{
    ...
    // compute q0
    float fInvLength = 1.f / sqrtf(m[0][0]*m[0][0]
                                    + m[1][0]*m[1][0] +
                                    m[2][0]*m[2][0]);
    ...
    fInvLength = 1.f / sqrtf(m[0][1]*m[0][1] +
                               m[1][1]*m[1][1] +
                               m[2][1]*m[2][1]);
    ...
    fInvLength = 1.f / sqrtf(m[0][2]*m[0][2] +
                               m[1][2]*m[1][2] +
                               m[2][2]*m[2][2]);
                                ...
                                Vector3& kD, Vector3& kU) const
{
    ...
    if (fInvLength > 1e-6f)
        fInvLength = 1.f / sqrtf(fInvLength);
                                ...
                                Radian& rfRAngle) const
{
    ...
    rfPAngle = Radian(asinf(m[0][2]));
    if ( rfPAngle < Radian(M_PI_2) )
    {
        if ( rfPAngle > Radian(-M_PI_2) )
        {
        ...
        else
        {
            ...
            Radian fRmY = atan2f(m[1][0],m[1][1]);
    ...
    {
        // WARNING.  Not a unique solution.
        Radian fRpY = atan2f(m[1][0],m[1][1]);
        rfRAngle = Radian(0.0);  // any angle works
                                ...
                                Radian& rfRAngle) const
{
    ...
    if ( rfPAngle < M_PI_2 )
    {
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRmY = atan2f(-m[2][0],m[2][2]);
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = rfRAngle - fRmY;
            return false;
        }
    ...
    {
        // WARNING.  Not a unique solution.
        Radian fRpY = atan2f(-m[2][0],m[2][2]);
        rfRAngle = Radian(0.0);  // any angle works
        rfYAngle = fRpY - rfRAngle;
        return false;
    }
                                ...
                                Radian& rfRAngle) const
{
    ...
    if ( rfPAngle < Radian(M_PI_2) )
    {
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRmY = atan2f(-m[0][1],m[0][0]);
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = rfRAngle - fRmY;
            return false;
        }
    ...
    {
        // WARNING.  Not a unique solution.
        Radian fRpY = atan2f(-m[0][1],m[0][0]);
        rfRAngle = Radian(0.0);  // any angle works
        rfYAngle = fRpY - rfRAngle;
        return false;
    }
                                ...
                                Radian& rfRAngle) const
{
    ...
    if ( rfPAngle < Radian(M_PI_2) )
    {
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRmY = atan2f(m[2][1],m[2][2]);
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = rfRAngle - fRmY;
            return false;
        }
    ...
    {
        // WARNING.  Not a unique solution.
        Radian fRpY = atan2f(m[2][1],m[2][2]);
        rfRAngle = Radian(0.0);  // any angle works
        rfYAngle = fRpY - rfRAngle;
        return false;
    }
                                ...
                                Radian& rfRAngle) const
{
    ...
    if ( rfPAngle < Radian(M_PI_2) )
    {
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRmY = atan2f(m[0][2],m[0][0]);
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = rfRAngle - fRmY;
            return false;
        }
    ...
    {
        // WARNING.  Not a unique solution.
        Radian fRpY = atan2f(m[0][2],m[0][0]);
        rfRAngle = Radian(0.0);  // any angle works
        rfYAngle = fRpY - rfRAngle;
        return false;
    }
                                ...
                                Radian& rfRAngle) const
{
    ...
    if ( rfPAngle < Radian(M_PI_2) )
    {
        ...
        {
            // WARNING.  Not a unique solution.
            Radian fRmY = atan2f(-m[0][1],m[0][2]);
            rfRAngle = Radian(0.0);  // any angle works
            rfYAngle = rfRAngle - fRmY;
            return false;
        }
    ...
    {
        // WARNING.  Not a unique solution.
        Radian fRpY = atan2f(-m[0][1],m[0][2]);
        rfRAngle = Radian(0.0);  // any angle works
        rfYAngle = fRpY - rfRAngle;
        return false;
    }
